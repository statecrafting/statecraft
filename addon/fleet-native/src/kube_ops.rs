...
//! (spec 006 §1): `Client::try_default` resolution and create-or-tolerate-409
...
/// Rust-side (spec 006 §2); the TS layer never opens the file.
...
/// RWO volume for the Job to mount (spec 006 §3).
